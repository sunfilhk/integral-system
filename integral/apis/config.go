...
func GetConfigByConfigKey(c *gin.Context) {
	...
	//Config.Deptid,_= utils.StringToInt64(c.Request.FormValue("deptid"))  //新修改
	result, err := Config.Get()
	pkg.AssertErr(err, "抱歉未找到相关信息", -1)
...
//	var data models.Config
//	//var def models.SysUser
//	//data.Deptid ,_= utils.StringToInt64(c.Request.FormValue("deptid"))
//	param := make(map[string]string)
//	param["teamp_id"]= c.Request.FormValue("teamp_id")
//	//param["userid"] = c.Request.FormValue("userid")
//	var res models.Response
//	var err error
//	 //userid:=utils.GetUserIdStr(c)
//	//def.Id ,_= utils.StringToInt64(c.Request.FormValu)
//	//data,_=data.Getdept(def.Id)
//	res.Data,err = data.GetConfig(param) //原来的
