...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"中悦云创","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var runtime = __webpack_require__(/*! ../helpers/regeneratorRuntime */ 192)();
...
/***/ 194:
/*!************************************************************************************!*\
  !*** D:/zhDome/zhongyue-h5/uni_modules/uni-forms/components/uni-forms/validate.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 220:
/*!*********************************************************************************!*\
  !*** D:/zhDome/zhongyue-h5/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 25:
/*!****************************************!*\
  !*** D:/zhDome/zhongyue-h5/pages.json ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 32:
/*!**********************************************!*\
  !*** D:/zhDome/zhongyue-h5/common/costum.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 47:
/*!*******************************************!*\
  !*** D:/zhDome/zhongyue-h5/common/api.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.allowNewUserPass = allowNewUserPass;
exports.customerAdd = customerAdd;
exports.customerAuditList = customerAuditList;
exports.customerEdit = customerEdit;
exports.customerList = customerList;
exports.customerLog = customerLog;
exports.customerLogAudit = customerLogAudit;
exports.customerLogList = customerLogList;
exports.deptTree = deptTree;
exports.getCaptcha = getCaptcha;
exports.getConfigKey = getConfigKey;
exports.getCustomerByid = getCustomerByid;
exports.getInvestmentByid = getInvestmentByid;
exports.getUserInit = getUserInit;
exports.getUserPerformance = getUserPerformance;
exports.getUserProfits = getUserProfits;
exports.getUserReferrals = getUserReferrals;
exports.investmentAdd = investmentAdd;
exports.investmentBreak = investmentBreak;
exports.investmentEdit = investmentEdit;
exports.investmentList = investmentList;
exports.investmentRevoke = investmentRevoke;
exports.login = login;
exports.passingSysUserList = passingSysUserList;
exports.submitNewUser = submitNewUser;
exports.userAuditRecord = userAuditRecord;
exports.userPwd = userPwd;
var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 48));
var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ 49));
...
function investmentRevoke(data) {
  data = _qs.default.stringify(data);
  return (0, _request.default)({
...
function getInvestmentByid(data) {
  return (0, _request.default)({
...
function customerAuditList(data) {
  return (0, _request.default)({
...
function customerLogAudit(data) {
  data = _qs.default.stringify(data);
  return (0, _request.default)({
...
function passingSysUserList(data) {
  return (0, _request.default)({
...
function allowNewUserPass(data) {
  data = _qs.default.stringify(data);
  return (0, _request.default)({
...
function getUserReferrals(data) {
  return (0, _request.default)({
...
/***/ 48:
/*!***********************************************!*\
  !*** D:/zhDome/zhongyue-h5/common/request.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
// let server_url=process.env.NODE_ENV === 'development' ? 'http://192.168.1.23:8001' : 'http://yun.fsector.io:8001' ; //环境配置
var server_url =  true ? 'http://192.168.1.23:8001' : undefined; //环境配置更新
function service() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  if (token != '') {
    options.header = {
      Authorization: "Bearer ".concat(token) //Bearer
    };
  }
...
var stringify = __webpack_require__(/*! ./stringify */ 50);
...
var getSideChannel = __webpack_require__(/*! side-channel */ 51);
...
var GetIntrinsic = __webpack_require__(/*! get-intrinsic */ 52);
var callBound = __webpack_require__(/*! call-bind/callBound */ 58);
var inspect = __webpack_require__(/*! object-inspect */ 60);
...
var hasSymbols = __webpack_require__(/*! has-symbols */ 53)();
...
var bind = __webpack_require__(/*! function-bind */ 55);
var hasOwn = __webpack_require__(/*! has */ 57);
...
var hasSymbolSham = __webpack_require__(/*! ./shams */ 54);
...
var implementation = __webpack_require__(/*! ./implementation */ 56);
...
var utilInspect = __webpack_require__(/*! ./util.inspect */ 61);
